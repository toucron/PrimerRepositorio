...
Original file is located at
    https://colab.research.google.com/drive/1o7n2ER0CabiaZCYyRrDV-w8wYE-l5Vce
"""
...
class RegresionLogistica:
  def __init__(self, y, X):
    ...
    Si no interesa entrenar el modelo
    n=len(y)
    n_train=int(n*0.8)
    n_test=n-n_train
    random.seed(10)
    ...
    datos_test = datos.drop(cuales)   #datos con el 20 porciento de los datos
